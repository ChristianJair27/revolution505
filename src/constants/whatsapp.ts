...
export const WA = {
  ...
  /** CTA genérico post-formulario (sin datos). Preferir waFromLead. */
  contacto:     BASE + enc('Hola Revolution505, completé el formulario de contacto y quiero hablar de mi proyecto.'),
} as const
